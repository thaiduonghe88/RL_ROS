...
echo_and_run cd "/home/user/simulation_ws/src/openai_ros/openai_ros"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/user/simulation_ws/src/openai_ros/openai_ros/setup.py" \
    build --build-base "/home/user/simulation_ws/build/openai_ros/openai_ros" \
    install \
    $DESTDIR_ARG \
